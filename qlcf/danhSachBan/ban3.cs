...
{
    public partial class ban3 : Form
    {
        public ban3()
        {
            InitializeComponent();
        }
        thucDon xb3 = new thucDon();
        string mahoadon;
        private void ban3_Load(object sender, EventArgs e)
        {
        ...
        private void dataBan3_RowEnter(object sender, DataGridViewCellEventArgs e)
        {
            int dong;
            dong = e.RowIndex;
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            if (this.txtMaHoaDon.TextLength == 0)
              ...
              if (this.txtMaHoaDon.TextLength > 10)
                ...
                xb3.themBan3(this.txtMaHoaDon.Text, cbDoUong.SelectedValue.ToString(), txtSoLuong.Text);
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            {
                xb3.suaBan3(txtMaHoaDon.Text, cbDoUong.SelectedValue.ToString(), txtSoLuong.Text);
